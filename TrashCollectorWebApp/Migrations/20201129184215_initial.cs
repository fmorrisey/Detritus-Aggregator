...
namespace TrashCollectorWebApp.Migrations
{
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Employees",
                columns: new[] { "Employee_ID", "FirstName", "IdentityRoleId", "IdentityUserId", "LastName", "Title", "Zip" },
                values: new object[] { 1, "Detritus", null, null, "Aggregator", "Sanitation Extraordinare", 0 });
